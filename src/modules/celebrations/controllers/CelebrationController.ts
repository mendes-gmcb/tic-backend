...
class CelebrationController{
    public async create(request: Request, response: Response): Promise<Response>{
        ...
        const newCelebration = await createService.execute({day, hour, solemnitie, confirm_celebration})
    ...
    public async update(request: Request, response: Response): Promise<Response>{
        ...
        const updatedCelebration = await updateService.execute({id, day, hour, solemnitie, confirm_celebration})
